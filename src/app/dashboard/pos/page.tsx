  ...
  return (
    <div className="h-full flex flex-col gap-4 pb-20 select-none" dir="rtl">
      ...
      <div className="bg-white dark:bg-slate-900 p-3.5 rounded-2xl border border-slate-200/90 dark:border-slate-800 shadow-sm space-y-3">
        {/* Category Tabs with slim horizontal scrollbar */}
        <div className="flex items-center gap-2 overflow-x-auto pb-2.5 pt-0.5 custom-scrollbar-horizontal scroll-smooth">
          <button
            type="button"
            onClick={() => setSelectedCatId('all')}
            className={`px-4 py-2.5 rounded-xl text-xs font-black shrink-0 transition-all cursor-pointer border ${
              selectedCatId === 'all'
                ? 'bg-blue-600 text-white border-blue-500 shadow-md shadow-blue-600/25'
                : 'bg-slate-100 dark:bg-slate-800 text-slate-800 dark:text-slate-200 border-slate-200 dark:border-slate-700/80 hover:bg-slate-200 dark:hover:bg-slate-700 hover:text-slate-900 dark:hover:text-white'
            }`}
          >
                        ...
                        <td className="p-3 text-center">
                          <div className="flex items-center justify-center gap-1.5">
                            <button 
                              ...
                              className="w-8 h-8 rounded-lg bg-slate-100 dark:bg-slate-800 hover:bg-slate-200 dark:hover:bg-slate-700 text-slate-700 dark:text-slate-300 flex items-center justify-center font-black cursor-pointer"
                            >
                            ...
                            <input
                              ...
                              className="w-16 h-8 text-center font-mono font-black text-sm bg-slate-50 dark:bg-slate-800 border border-slate-300 dark:border-slate-700 rounded-lg text-slate-900 dark:text-white focus:ring-1 focus:ring-blue-500"
                            />
                            <button 
                              type="button"
                              onClick={() => updateQuantity(item.id, 1)}
          ...
          <div className="space-y-4">
            ...
            <div className="grid grid-cols-2 gap-2">
              <button
                ...
                className={`flex items-center justify-center gap-2 py-3.5 rounded-xl font-black text-sm transition-all cursor-pointer border ${
                  paymentMethod === 'cash'
                    ? 'bg-blue-600 text-white border-blue-500 shadow-md shadow-blue-600/30'
                    : 'bg-slate-100 dark:bg-slate-800 text-slate-800 dark:text-slate-200 border-slate-300 dark:border-slate-700 hover:bg-slate-200 dark:hover:bg-slate-700 hover:text-slate-900 dark:hover:text-white'
                }`}
              >
